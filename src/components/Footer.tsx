          ...
          <div className="md:col-span-4 space-y-5">
            ...
            <div className="space-y-2.5 text-sm font-sans" style={{ color: '#475569' }}>
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="tel:+15624705073" className="transition-colors hover:text-sky-600">+1 562 470 5073</a>
              </div>
              <div className="flex items-center gap-2">
                ...
                <a href="https://wa.me/15624705073?text=Hello%20Doctor%20Commerce!%20I'm%20writing%20to%20inquire%20about%20your%20expert%20services."
